...
export const GetUserInfo = def({ id: 1774907609, name: "GetUserInfo", direction: "c2s", schema: [{ name: "nickname", type: "string" }] });
export const OnlineNotifierData = def({ id: 2041598093, name: "OnlineNotifierData", direction: "s2c", schema: [{ name: "isOnline", type: "bool" }, { name: "server", type: "i32" }, { name: "nickname", type: "string" }] });
export const RankNotifierData = def({ id: -962759489, name: "RankNotifierData", direction: "s2c", schema: [{ name: "rank", type: "u8" }, { name: "nickname", type: "string" }] });
export const PremiumNotifierData = def({ id: -2069508071, name: "PremiumNotifierData", direction: "s2c", schema: [{ name: "premiumTimeLeftInSeconds", type: "i32" }, { name: "nickname", type: "string" }] });
...
// Mostra o alerta de premium ativado (modelo 11, mesmo dispatcher do PremiumInfo).
// returning=true → "TEXT_PREMIUM_ALERT_RETURN" (renovação); false → "TEXT_PREMIUM_ALERT_WELCOM".
export const ShowPremiumAlert = def({ id: -478572181, name: "ShowPremiumAlert", direction: "s2c", schema: [{ name: "returning", type: "bool" }] });
